// /Users/montysharma/V11M2/src/components/CharacterCreation/Step4_Review.tsx
...
const Step4_Review: React.FC = () => {
  ...
  const getAttributesByCategory = () => {
    if (!currentCharacter?.attributes) return {};
    
    return {
      cognitive: {
        intelligence: currentCharacter.attributes.intelligence,
        creativity: currentCharacter.attributes.creativity,
        memory: currentCharacter.attributes.memory,
        focus: currentCharacter.attributes.focus
      },
      physical: {
        strength: currentCharacter.attributes.strength,
        agility: currentCharacter.attributes.agility,
        endurance: currentCharacter.attributes.endurance,
        dexterity: currentCharacter.attributes.dexterity
      },
      social: {
        charisma: currentCharacter.attributes.charisma,
        empathy: currentCharacter.attributes.empathy,
        communication: currentCharacter.attributes.communication
      },
      mental: {
        emotionalStability: currentCharacter.attributes.emotionalStability,
        perseverance: currentCharacter.attributes.perseverance,
        stressTolerance: currentCharacter.attributes.stressTolerance,
        adaptability: currentCharacter.attributes.adaptability,
        selfControl: currentCharacter.attributes.selfControl
      }
    };
  };
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <Card title="Step 4: Character Review" className="text-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card title="Character Summary" variant="elevated">
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Attributes by Category</h3>
              <div className="space-y-4">
        ...
        <Card title="Character JSON Data" variant="elevated">
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <p className="text-gray-600">
                This is the JSON representation of your character that will be used in the game:
              </p>
              <Button
